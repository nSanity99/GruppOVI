        ...
        <?php if ($user_role_from_session === 'admin'): ?>
            <div class="tool-cards-grid">
                ...
                <a href="view_logs.php" class="tool-card">
                    <div class="tool-card-header"><div class="tool-card-icon">📄</div><h3 class="tool-card-title">Log Utenti</h3></div>
                    <p class="tool-card-description">Controlla cronologia azioni e accessi.</p>
                </a>
            </div>
        <?php endif; ?>
